...
---
{% note danger modern %}
本文包含大量图片，如果您在使用移动网络请注意流量费用。少部分未经压缩的图片体积高达30MB甚至更高，加载较慢请耐心等待。建议使用中国大陆以外的网络节点以加速访问。
{% endnote %}
...
{% dplayer "url=/photo/media/VID_20230621_182349.mp4" %}
